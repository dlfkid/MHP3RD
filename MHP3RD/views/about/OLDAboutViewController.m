...
#import "OLDAboutViewController.h"
...
@implementation OLDAboutViewController
...
- (void)configureFrieds {
    ...
    friends.backgroundColor = [UIColor whiteColor];
    friends.tag = 1;
    friendsTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 64, VIEWWIDTH, VIEWHEIGHT) style:UITableViewStylePlain];
